...
export default function CassetteTape({isPlaying, progress, image}: CassetteTapeProps) {
	return (
		<figure className={`${styles.cassetteTape} ${isPlaying ? styles.playing: ''}`}>
			...
			<img draggable="false" className={styles.tapeCoverImage} src={image} alt="cover" />
