...
import { fetchUserWindows, selectWindowsStatus } from './features/window/windowSlice'
...
function App(): JSX.Element {
  ...
  return (
    <>
      <Header />
      <Body/>
      {windowStatus === 'loading' && <section className={styles.AppLoader} ><AnimatedLogo /><p className={styles.loading}>Loading . . .</p></section>}
      <Toaster />
    </>
  )
}
